...
const NAV_ITEMS = {
    bam_admin: [
        ...
        { path: '/my-knowledge', icon: User, label: 'My Stuff', requiresClient: true },
        { path: '/library', icon: Users, label: 'Library', requiresClient: true },
        { path: '/knowledge-base', icon: Lock, label: 'Knowledge Base', requiresClient: true },
        { path: '/vault', icon: Shield, label: 'Vault', requiresClient: true },
        { path: '/consumer', icon: MessageSquare, label: 'Brain', requiresClient: true },
